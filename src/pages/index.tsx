  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Foox again - Your Gateway to the Ultimate Marketplace for Freelancers and Companies Offering Jobs. Connect, Collaborate, and Create Opportunities."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Foox again - Your Gateway to the Ultimate Marketplace for Freelancers and Companies Offering Jobs. Connect, Collaborate, and Create Opportunities.`}
            </Text>
            <Box
